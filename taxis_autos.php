...
class Taxi extends automobil
{
    ...
    private $fuvarKm = 0.0;
    private $hossza = 0;
    public function __construct($tipus,$fogy,$uzemanyagTartalyMeret,$kmOra)
    {
        parent::__construct($tipus,$fogy,$uzemanyagTartalyMeret);
        $this -> kmDij = $kmOra;
    }

    public function fuvar ($tavolsag)
    {
        $this->megy($tavolsag);
        $this->fuvarKm += $tavolsag;
        $this->kassza += $tavolsag+$this->kmDij;
    }
